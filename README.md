...
src/
  ...
  assets/fonts/                   # Self-hosted Montserrat and JetBrains Mono files
...
- Color mathematics and binary profile/container code are ported from the supplied superGLOW scripts: https://superglow.stacktreelabs.com/. The original imperative `main.js` UI is replaced with Angular components and services.
